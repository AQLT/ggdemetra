...
Since RJDemetra relies on the [rJava](https://CRAN.R-project.org/package=rJava) package and Java SE 8 or later version is required, the same requirements are also needed for ggdemetra.

ggdemetra is not on CRAN for the moment and uses the development version of RJDemetra. To use it you need to install both GitHub version:
